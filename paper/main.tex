...
To complement the supervised attention-based analysis, we employed an unsupervised learning approach to characterize the global landscape of TCR repertoires. While the supervised model explicitly learns to discriminate between responders and non-responders, unsupervised analysis discovers inherent structures and clusters within the data without access to response labels. This serves as a critical orthogonal validation: if the natural data distribution segregates by clinical outcome, it strongly supports the biological relevance of the TCR repertoire in determining CAR-T response.
