...
\caption{\textbf{Unsupervised Sequence-Space Visualization.} A two-dimensional visualization of an unsupervised latent embedding of TRB sequences derived from CDR3 k-mer features and V/J gene usage. Points are colored by attention-based importance (proxy for ``predictive'' sequences) and top vs. bottom deciles highlight enrichment of high-importance sequences within specific regions of sequence space, analogous to unsupervised visualization strategies used in DeepTCR studies.}
\label{fig:s11}
\end{figure}
